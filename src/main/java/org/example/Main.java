...
class homeWork1Class {
    public static void main (String[] args) {
        ...
        short priceMunaDouble = 3412;
        System.out.println(priceMunaDouble);
        short taxMunaDouble = 623;
        System.out.println(taxMunaDouble);
        int quantity = 2356;
        System.out.println(quantity);
        double sum = 0;
        System.out.println(sum);

        double tax = priceMunaDouble + taxMunaDouble * quantity + sum;
